#!/usr/bin/python3
"""Unittests for models/city.py are defined.
...
class TestCity_instantiation(unittest.TestCase):
    """Unittests testing instantiation of the City class."""
...
class TestCity_save(unittest.TestCase):
    """Unittests testing save method of the City class."""
...
class TestCity_to_dict(unittest.TestCase):
    """Unittests testing to_dict method of the City class."""
