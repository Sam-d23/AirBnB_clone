#!/usr/bin/python3
"""Unittests for models/place.py are defined.
...
class TestPlace_instantiation(unittest.TestCase):
    """Unittests testing instantiation of the Place class."""
...
class TestPlace_save(unittest.TestCase):
    """Unittests testing save method of the Place class."""
...
class TestPlace_to_dict(unittest.TestCase):
    """Unittests testing to_dict method of the Place class."""
